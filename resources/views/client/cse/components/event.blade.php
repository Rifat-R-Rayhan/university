            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="uni-image/event.jpg" alt=""
                                class="img-fluid"></a>
                        <div class="post-meta"><span class="date">Events</span> <span
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="uni-image/event3.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Events</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="uni-image/event1.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Events</span> <span
