...
@section('content')
    <div class="container py-3 py-lg-5">
        <div class="fables-team my-3">
            <h3 class="fables-second-text-color mb-5 font-weight-bold"> BOART OF TRUSTEES </h3>
            <div class="row">
                <div class="col-12 col-md-3 mb-4 mb-lg-5">
                    <div
                        ...
                        <div class="image-container shine-effect">
                            <a href="#"><img class="w-100" src="assets/custom/images/team3-1.jpg"
                                    alt="Card image cap"></a>
                        </div>
                        <div class="card-body">
                            <h5><a href="#"
                                    class="font-20 semi-font fables-forth-text-color fables-second-hover-color team-name">JOHN
                                    MARTIN</a></h5>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 mb-4 mb-lg-5">
                    <div
                        class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
                        <div class="image-container shine-effect">
                            <a href="#"><img class="w-100" src="assets/custom/images/team3-2.jpg"
                                    alt="Card image cap"></a>
                        </div>
                        <div class="card-body">
                            <h5><a href="#"
