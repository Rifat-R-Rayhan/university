    ...
    <div class="container position-relative z-index">
        <div class="row">
            <div class="col-12 col-lg-6 p-0 image-container translate-effect-right wow fadeInLeft mb-3 mb-md-0"
                ...
                <img src="uni-image/NUB_Rifat.jpg" alt="" class="w-100 h-100">
            </div>
...
position-absolute fables-lus-icon pt-2 text-center">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Northern University Bangladesh may have a strong reputation in certain academic programs or disciplines. Students interested in these fields may choose the university for its academic excellence.
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 mb-2">
...
position-absolute fables-lus-icon pt-2 text-center">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                The presence of experienced and knowledgeable faculty members can be a significant factor. Students often seek universities with renowned professors and scholars in their chosen fields.
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 mb-2">
...
position-absolute fables-lus-icon pt-2 text-center">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            data-parent="#accordion">
                            <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Tuition fees at Northern University Bangladesh may be competitive or affordable compared to other institutions, making it an attractive option for students who want to pursue higher education without incurring excessive debt.
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 mb-2">
...
position-absolute fables-lus-icon pt-2 text-center">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                            <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                Availability of scholarships and financial aid can greatly influence a student's decision. If Northern University Bangladesh offers financial support or scholarships that align with a student's qualifications, it can be a compelling reason to choose the university.
                            </div>
                        </div>
                    </div>
                </div>
